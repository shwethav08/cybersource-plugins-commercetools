...
import { Constants } from '../../src/presentation/fashion/PageCheckout/PaymentMethod/IsvPayment/Constants';
            ...
            variables: {
              draft: {
                ...
                country: getValue(location),
                 ...(Constants.STRING_TRUE !==  multipleShipping)&&{shippingAddress: {
                  country: getValue(location),
                }},
                ...(Constants.STRING_TRUE ==  multipleShipping)&&{shippingMode: Constants.STRING_MULTIPLE},
              },
            },
          }).then((result) => ({
