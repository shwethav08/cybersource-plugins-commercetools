...
import TabMyCards from "presentation/User/TabMyCards/TabMyCards.vue";
import TabMyCardsUpdate from "presentation/User/TabMyCardsUpdate/TabMyCardsUpdate.vue";
      ...
      },
      {
        ...
        children: [
          ...
          {//TODO:Modified
              path: 'mycards',
              name: 'mycards',
              component: TabMyCards,
          },
          { 
            path: 'card/:token', name: 'update', component: TabMyCardsUpdate,
          },
          {
            path: 'order/:id',
            name: 'order',
